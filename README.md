...
### Spikes
Décors (`clairiere`, `donjon`, `ruelle`, `place`, `village`), échelles et caméras (`carte`, `scene`, `recul`, `scroll-*`), présences (`marque`, `fantome`, `perso`), matière du texte (`fremir`, `matiere`).
